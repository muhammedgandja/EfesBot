...
exports.run = (client, message, args) => {
  ...
  if (!message.guild.member(user).kickable) return message.reply('Sunucudan Atman İçin Yetkin Olması Lazım!');
  message.guild.member(user).kick();

  const embed = new Discord.RichEmbed()
  .setAuthor("Black | Moderatör", "https://i.hizliresim.com/5DNb6d.jpg")
